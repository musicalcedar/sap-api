...
export const mapFromSapBusinessPartner = (
  ...
  const result: Partial<SapBusinessPartnerRaw> = {
    ...
    BillToState: getDepartmentCode(partner.department || ''),
    ShipToState: getDepartmentCode(partner.department || ''),
    Priority: -1,
    ...
    U_BPCO_CS: getMunicipalityCode(partner.city || ''),
    U_BPCO_City: partner.U_BPCO_City || partner.city,
    U_Departamento_CC: getDepartmentCode(partner.department || ''),
    U_Ciudad_CC: getMunicipalityCode(partner.city || ''),
    ...
    U_ZonaPostal_CC: getMunicipalityCode(partner.city || ''),
    U_DocFormEnt: '1',
    ...
    BPAddresses: Array.isArray(partner.addresses)
      ? partner.addresses.map((addr, index) => ({
          ...
          State: addr.State || getDepartmentCode(partner.department || '05'),
          ...
          U_Municipio: addr.U_Municipio || getMunicipalityCode(addr.City || partner.city || ''),
          U_CodDepartamento: addr.U_CodDepartamento || getDepartmentCode(partner.department || ''),
        }))
      : [],
  };
  return result;
